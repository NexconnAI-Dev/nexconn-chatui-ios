...
/// For example, when forwarding combined messages or uploading attachments to an App file server,
/// use this interceptor.
///
/// @warning If you use ChatUI, you can set and implement this protocol.
///
/// Choose one of the two approaches based on your use case. For uploading media attachments to an
/// App file server, this approach is recommended.
...
/// @return YES if the message is intercepted (SDK will not process it further); NO to let the SDK
/// proceed. This method is called when a normal message is about to be sent. You can filter or
/// modify the message parameters. If you only need to modify the content, update it and return NO
/// so the SDK continues sending.
...
/// @return YES if the message is intercepted (SDK will not process it further); NO to let the SDK
/// proceed. This method is called when a media message is about to be sent. You can filter or
...
/// This method is called after a message has been sent. You can check message.sentStatus to
