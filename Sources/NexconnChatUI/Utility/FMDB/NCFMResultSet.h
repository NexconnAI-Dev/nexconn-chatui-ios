...
/** Represents the results of executing a query on an `<NCFMDatabase>`.
...
@interface NCFMResultSet : NSObject {
    NCFMDatabase *_parentDB;
    NCFMStatement *_statement;
...
/** `NCFMStatement` used by result set. */

@property (atomic, retain) NCFMStatement *statement;

///------------------------------------
/// @name Creating and closing database
///------------------------------------

/** Create result set from `<NCFMStatement>`

 @param statement A `<NCFMStatement>` to be performed

 @param aDB A `<NCFMDatabase>` to be used
