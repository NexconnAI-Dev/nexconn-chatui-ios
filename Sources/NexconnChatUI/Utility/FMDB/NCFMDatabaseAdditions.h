...
/** Category of additions for `<NCFMDatabase>` class.
...
@interface NCFMDatabase (NCFMDatabaseAdditions)
...
/** The schema of the database.
 ...
 - Returns: `NCFMResultSet` of schema; `nil` on error.
