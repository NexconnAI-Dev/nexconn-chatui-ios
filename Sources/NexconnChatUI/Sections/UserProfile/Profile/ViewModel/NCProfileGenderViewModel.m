...
- (void)registerCellForTableView:(UITableView *)tableView {
    [tableView registerClass:NCProfileGenderCell.class forCellReuseIdentifier:NCProfileGenderCellIdentifier];
}
...
- (NSArray<NCProfileGenderCellViewModel *> *)dataSource {
    if (!_dataSource) {
        NCProfileGenderCellViewModel *maleVM = [NCProfileGenderCellViewModel cellViewModel:NCChatUIUserGenderMale];
        maleVM.isSelect = (self.profle.gender == NCChatUIUserGenderMale);
        
        NCProfileGenderCellViewModel *femaleVM = [NCProfileGenderCellViewModel cellViewModel:NCChatUIUserGenderFemale];
...
- (void)updateUserProfileGender:(UIViewController *)viewController {
    ...
    [[NCEngine userModule] updateMyUserProfile:self.profle completion:^(NSArray<NSString *> * _Nullable errorKeys, NCError * _Nullable error) {
