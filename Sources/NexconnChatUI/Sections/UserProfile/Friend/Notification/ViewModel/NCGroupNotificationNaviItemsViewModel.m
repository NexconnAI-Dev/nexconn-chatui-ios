//
//  NCGroupNotificationNaviItemsViewModel.m
//  NexconnChatUI
//
...
@implementation NCGroupNotificationNaviItemsViewModel
@dynamic delegate;
...
- (void)btnClick:(UIButton *)btn {
    if ([self.delegate respondsToSelector:@selector(userDidSelectCategory:)]) {
        [self.delegate userDidSelectCategory:(NCGroupNotificationCategory)btn.tag];
    }
