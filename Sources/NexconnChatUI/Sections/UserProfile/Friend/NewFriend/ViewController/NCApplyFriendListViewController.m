//
//  NCApplyFriendListViewController.m
//  NexconnChatUI
//
...
- (void)setupView {
    ...
    if (!self.title) {
        self.title = NCUILocalizedString(@"friend_application_new_friend");
    }
...
- (NCApplyFriendListView *)listView {
    if (!_listView) {
        NCApplyFriendListView *listView = [NCApplyFriendListView new];
