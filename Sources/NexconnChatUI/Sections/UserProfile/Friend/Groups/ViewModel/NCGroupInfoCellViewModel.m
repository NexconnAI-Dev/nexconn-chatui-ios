...
+ (void)registerCellForTableView:(UITableView *)tableView {
    [tableView registerClass:[NCGroupListCell class]
        forCellReuseIdentifier:NCGroupListCellIdentifier];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView
    ...
    if (self.groupInfo) {
        ...
        cell.labName.attributedText = [self attributedString:self.groupInfo.groupName
...
- (void)itemDidSelectedByViewController:(UIViewController *)vc {
    ...
    NCChannelViewController *conversationVC =
        [[NCChannelViewController alloc] initWithChannelType:NCChannelTypeGroup
                                                   channelId:self.groupInfo.groupId];
    [vc.navigationController pushViewController:conversationVC animated:YES];
}

- (NSMutableAttributedString *)attributedString:(NSString *)string withKeyword:(NSString *)keyword {
    if (string == nil) {
