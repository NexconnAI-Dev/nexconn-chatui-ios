...
+ (void)registerCellForTableView:(UITableView *)tableView {
    [tableView registerClass:[NCFriendListCell class] forCellReuseIdentifier:NCFriendListCellIdentifier];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView
    ...
    NCFriendListCell *cell = [tableView dequeueReusableCellWithIdentifier:NCFriendListCellIdentifier forIndexPath:indexPath];
