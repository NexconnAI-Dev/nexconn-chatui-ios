...
- (void)setupConstraints {
    ...
    [NSLayoutConstraint activateConstraints:@[
           [self.portraitImageView.topAnchor constraintEqualToAnchor:self.topAnchor constant:NCGroupCreateViewNameTopSpace],
           [self.portraitImageView.centerXAnchor constraintEqualToAnchor:self.centerXAnchor],
           [self.portraitImageView.widthAnchor constraintEqualToConstant:NCGroupCreateViewPortraitSize],
           [self.portraitImageView.heightAnchor constraintEqualToConstant:NCGroupCreateViewPortraitSize],
           
           [self.nameEditView.topAnchor constraintEqualToAnchor:self.portraitImageView.bottomAnchor constant:NCGroupCreateViewNameTopSpace],
           ...
           [self.nameEditView.heightAnchor constraintEqualToConstant:NCGroupCreateViewPortraitSize*2],
           
           [self.createButton.bottomAnchor constraintEqualToAnchor:self.bottomAnchor constant:-NCGroupCreateViewCreateBottom],
           [self.createButton.leadingAnchor constraintEqualToAnchor:self.leadingAnchor constant:NCGroupCreateViewCreateLeading],
           [self.createButton.trailingAnchor constraintEqualToAnchor:self.trailingAnchor constant:-NCGroupCreateViewCreateLeading],
...
- (NCNameEditView *)nameEditView {
    if (!_nameEditView) {
        ...
        _nameEditView.textField.placeholder = NCUILocalizedString(@"group_name_edit_placeholder_with_limit");
...
- (NCBaseButton *)createButton {
    if (!_createButton) {
        ...
        [_createButton setTitle:NCUILocalizedString(@"group_create") forState:(UIControlStateNormal)];
