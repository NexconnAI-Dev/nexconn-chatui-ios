//
//  NCGroupTransferViewController.m
//  NexconnChatUI
//
...
@interface NCGroupTransferViewController () <UITableViewDelegate, UITableViewDataSource,
                                             NCListViewModelResponder>

@property (nonatomic, strong) NCSelectUserView *membersView;

@property (nonatomic, strong) NCGroupTransferViewModel *viewModel;

@property (nonatomic, strong) UILabel *emptyLabel;

@end

@implementation NCGroupTransferViewController
...
- (instancetype)initWithViewModel:(NCGroupTransferViewModel *)viewModel {
    ...
    if (self) {
        ...
        self.title = NCUILocalizedString(@"group_transfer_vc_title");
    }
    return self;
}
