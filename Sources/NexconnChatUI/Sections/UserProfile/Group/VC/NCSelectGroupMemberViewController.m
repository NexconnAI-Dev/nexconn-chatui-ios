//
//  NCSelectGroupMemberViewController.m
//  NexconnChatUI
//
...
@interface NCSelectGroupMemberViewController () <UITableViewDelegate, UITableViewDataSource,
...
@property (nonatomic, strong) NCSelectGroupMemberViewModel *viewModel;

@end

@implementation NCSelectGroupMemberViewController
