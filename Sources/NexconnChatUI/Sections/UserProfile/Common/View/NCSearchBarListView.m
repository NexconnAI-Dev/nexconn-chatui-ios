...
- (UIView *)containerViewFor:(UIView *)bar {
    ...
    NSLayoutConstraint *leadingConstraint =
        [inner.leadingAnchor constraintEqualToAnchor:outer.leadingAnchor
                                            constant:NCUserManagementViewPadding];
    leadingConstraint.priority = UILayoutPriorityDefaultHigh; // 750

    NSLayoutConstraint *trailingConstraint =
        [inner.trailingAnchor constraintEqualToAnchor:outer.trailingAnchor
                                             constant:-NCUserManagementViewPadding];
...
- (UITableView *)tableView {
    if (!_tableView) {
        ...
        [tableView setContentHuggingPriority:UILayoutPriorityDefaultLow
