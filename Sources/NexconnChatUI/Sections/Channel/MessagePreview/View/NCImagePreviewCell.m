...
- (void)resizeSubviews {
    ...
    if (width < height) {
        if (imageWidth < width) {
            /*
             When both dimensions fit, scale the width to the viewport while preserving the aspect ratio and center the image.
             When the image is taller than the viewport, keep its original size, center it horizontally, and align it to the top.
             */
        ...
        /*
         ...
         1. For ratios below 0.45, retain the original size when it fits; otherwise scale the width to the viewport. Align tall images to the top.
         2. For ratios from 0.45 up to 1.7, scale the height to the viewport and center the image.
         3. For ratios of 1.7 or greater, scale the width to the viewport and center the image when its height fits.
         */
