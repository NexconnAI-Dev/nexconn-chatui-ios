...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView
    ...
    NCBaseCollectionViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:NCEmotionCollectCellIdentifier
                                                                           forIndexPath:indexPath];
    for (UIView *view in cell.contentView.subviews) {
        [view removeFromSuperview];
    }
    NCBaseImageView *imageView = [[NCBaseImageView alloc] initWithFrame:CGRectMake(12, 8, cell.contentView.frame.size.width-24, cell.contentView.frame.size.height-16)];
...
- (NCBaseCollectionView *)emotionsListView{
    if (!_emotionsListView) {
        ...
        _emotionsListView =
            [[NCBaseCollectionView alloc] initWithFrame:CGRectZero collectionViewLayout:flowLayout];
