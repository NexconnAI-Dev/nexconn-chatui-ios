...
/**
 *  Callback when downloading from iCloud fails: album data is read first, then iCloud is tried if
 * that fails. This callback is triggered if iCloud also fails. Mutually exclusive with
 * didChangeSelectedState below.
 */
