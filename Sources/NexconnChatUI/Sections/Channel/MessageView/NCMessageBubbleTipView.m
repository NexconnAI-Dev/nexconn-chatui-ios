...
#define kDefaultbubbleTipAlignment NC_MESSAGE_BUBBLE_TIP_VIEW_ALIGNMENT_TOP_RIGHT

@interface NCMessageBubbleTipView ()
@property (NS_NONATOMIC_IOSONLY, readonly) CGSize sizeOfTextForCurrentSettings;
@property (nonatomic, assign) int msgCount;
@end

@implementation NCMessageBubbleTipView
...
- (void)_init {
    ...
    self.bubbleTipBackgroundColor = NCDynamicColor(@"hint_color");
...
- (void)setBubbleTipAlignment:(NCMessageBubbleTipViewAlignment)bubbleTipAlignment {
