...
- (void)setText:(NSString *)text {
    _text = text.copy;
    [[NCYYTransaction transactionWithTarget:self selector:@selector(contentsNeedUpdated)] commit];
}
...
/// Creates the attributed string used for drawing.
...
- (CFArrayRef)createLinesFromFrame:(CTFrameRef)frame {
    // Retain and return the frame's CTLine array.
...
/// Finds the string index at a tapped point.
/// @param location The tap location in the view's coordinate system.
