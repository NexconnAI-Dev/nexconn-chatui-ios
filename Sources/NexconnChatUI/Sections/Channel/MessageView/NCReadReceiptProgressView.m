...
- (void)setupDefaultValues {
    ...
    UIColor *defaultColor = [UIColor colorWithRed:22.0 / 255.0
                                            green:210.0 / 255.0
                                             blue:88.0 / 255.0
                                            alpha:1.0];
...
- (void)setBorderColor:(UIColor *)borderColor {
    if (borderColor) {
        ...
        // Default green: #16D258.
        _borderColor = [UIColor colorWithRed:22.0 / 255.0
                                       green:210.0 / 255.0
                                        blue:88.0 / 255.0
                                       alpha:1.0];
    }
...
- (void)setFillColor:(UIColor *)fillColor {
    if (fillColor) {
        ...
        // Default green: #16D258.
        _fillColor = [UIColor colorWithRed:22.0 / 255.0
                                     green:210.0 / 255.0
                                      blue:88.0 / 255.0
                                     alpha:1.0];
    }
...
- (void)drawProgressWithContext:(CGContextRef)context
                        centerX:(CGFloat)centerX
                        centerY:(CGFloat)centerY
                         radius:(CGFloat)radius {
    CGContextSaveGState(context);
