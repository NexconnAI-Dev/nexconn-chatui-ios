...
@property (nonatomic, strong) NCBaseButton *closeBtn;
@property (nonatomic, strong) UILabel *currentTimeLab;
@property (nonatomic, strong) UILabel *durationTimeLabel;
@property (nonatomic, strong) UISlider *slider;
@property (nonatomic, strong) NCBaseButton *centerPlayBtn;
@property (nonatomic, strong) UIView *bottomView;
@property (nonatomic, strong) NCBaseView *topView;
...
@property (nonatomic, strong) NCBaseButton *extraButton;
@end

@implementation NCSightPlayerOverlayView
...
- (UILabel *)currentTimeLab {
    if (!_currentTimeLab) {
        ...
        _currentTimeLab.textColor = NCDynamicColor(@"control_title_white_color");
...
- (NCBaseButton *)extraButton {
    if (!_extraButton) {
        _extraButton = [[NCBaseButton alloc] init];
    }
    return _extraButton;
}
...
- (UILabel *)durationTimeLabel {
    if (!_durationTimeLabel) {
        ...
        _durationTimeLabel.textColor = NCDynamicColor(@"control_title_white_color");
...
- (NCBaseView *)topView {
    if (!_topView) {
        _topView = [[NCBaseView alloc] init];
...
- (void)setUp {
    ...
    self.thumbnailView = [[NCBaseImageView alloc] init];
    self.thumbnailView.backgroundColor = NCDynamicColor(@"pop_layer_background_color");
