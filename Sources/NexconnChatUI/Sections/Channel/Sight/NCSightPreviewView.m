...
@interface NCSightPreviewView () <UIGestureRecognizerDelegate>
...
@implementation NCSightPreviewView
...
- (UIView *)focusBox {
    if (!_focusBox) {
        ...
        _focusBox.layer.borderColor = NCDynamicColor(@"hint_color").CGColor;
